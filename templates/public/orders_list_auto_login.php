...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md text-center">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Carregando Pedidos</h1>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-sm text-gray-600">Buscando pedidos...</span>
                </div>
            </div>
        </div>
        ...
        <div id="error-state" class="hidden mt-6">
            <div class="bg-red-50 border border-red-200 rounded-xl p-6">
                ...
                <p class="text-red-600 mb-4">Você precisa fazer login para acessar seus pedidos.</p>
    ...
    <script>
        ...
        async function checkAutoLogin() {
            try {
                ...
                // Step 3: Set session and redirect to orders
